 ...
 * @author Kasun
 */
public class Garenter {
    private String garenterID_PK;
    ...
    public Garenter(String garenterID_PK, String firstName, String lastName, String address, String nic, String dob, String mobNum, String homeTell, String gender, String job, double monthSalary, String paysheetNum) {
        this.garenterID_PK = garenterID_PK;
    ...
    /**
     * @return the garenterID_PK
     */
    public String getGarenterID_PK() {
        return garenterID_PK;
    }

    /**
     * @param garenterID_PK the garenterID_PK to set
     */
    public void setGarenterID_PK(String garenterID_PK) {
        this.garenterID_PK = garenterID_PK;
    }
